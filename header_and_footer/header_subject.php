...
<body>
  <header>
      ...
      <ul>
        <ul>
          ...
          <li><i class="fa fa-upload w3-small"></i>
                <div class="popup" onclick="myFunction()"> <h1 style="text-transform: uppercase; font-size: 11px; font-weight: bold; font-family: Karla; display: inline;"> &nbsp Upload  </h1>
    ...
    <!-- search bar -->
    <section id="search">
      <form class="example" action="searchsubject2.php" style="margin:auto;max-width:600px">
