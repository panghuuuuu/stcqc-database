...
<body>
  <div id="header">
    ...
    <nav>
      ...
      <!-- search bar -->
      <section id="search">
        <form class="example" action="search2.php" style="margin:auto;max-width:600px">
          <input type="text" name="Search" id="searchbar" placeholder="Search..." value="<?php echo $_GET['Search'];?>">
