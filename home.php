...
<body>
  <div class="container">
    ...
    <?php include 'header_and_footer/header_noLogo2.php'; ?>
    ...
    <div class="content">
      <section id="first">
        ...
        <!-- searchbar-->
        <section id="search">
          <form class="example" action="search.php" style="margin:auto;max-width:600px">
      ...
      <section id="section">
        ...
        ?>
          ...
          <div id="box">
            <!-- TITLE -->
            <div id="boxtext">
              <h4 id="boxTitle"><a href="templateindiv.php?titleID=<?php echo $row["titleID"]; ?>">
